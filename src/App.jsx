...
function App() {
  ...
  return (
    <>
      ...
      <section id='mentors'>
      <div className='text-4xl font-bold text-center mt-8 text-white mb-8 font-poppins'>Our Faculty Mentors</div>

      <div className="min-h-screen rounded-2xl bg-custom-color flex items-center justify-center p-6">
...
ensuring our mission shines bright every day."
      ...
      <div className='text-4xl text-white font-poppins font-bold text-center mt-8 mb-8'>Meet Our Office Bearers</div>
    <div className="p-8 bg-custom-color font-poppins rounded-2xl">
